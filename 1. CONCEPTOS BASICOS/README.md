...
Para iniciar Ros debe de ser instalado el sistema operativo Ubuntu, es recomendable usarlas versiones 18.04 o 16.04 y asi mismo la version a instalar del ROS sera Melodic o Kinetic
